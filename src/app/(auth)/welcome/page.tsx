...
const Page = () => {
    ...
    const { data } = useQuery({
        queryFn: async () => {
            ...
            console.log("here is res.json", res)
    ...
    useEffect(() => {
        console.log("data i return",data)
    ...
    return <div className="w-full flex-1 flex items-center justify-center px-4">
        ...
        <div className="relative z-10 flex -translate-y-1/2 flex-col items-center gap-6 text-center ">
            ...
            <p className=" text-base text-gray-700 max-w-prose">Just a moment while we set thing up for your </p>
        </div>
